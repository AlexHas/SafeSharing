...
public class HistoryActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.action_add:{
                        Intent intent=new Intent(HistoryActivity.this, AddFileActivity.class);
                        startActivity(intent);
                        break;
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.files: {
                Intent intent = new Intent(HistoryActivity.this, FilesActivity.class);
                startActivity(intent);
                break;
            }
            case R.id.mainFolder: {
                Intent intent = new Intent(HistoryActivity.this, SetFolderActivity.class);
                startActivity(intent);
                break;
            }
//            case R.id.history: {
